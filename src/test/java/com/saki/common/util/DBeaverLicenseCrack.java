...
/**
 * 破解dbeaver的工具类，
 * dbeaver版本:2023.3 ultimate版本，官网下载即可
 * java版本17
 * 导入包${DBEAVER_HOME}/plugins中的com.dbeaver.app.ultimate_23.3.0.202312201943.jar，org.jkiss.lm_1.0.172.202312201943.jar，org.jkiss.utils_2.1.203.202312201943.jar
 * 下载后，用户目录下创建 /.jkiss-lm文件夹,公钥私钥文件将会生成在这个目录中
 * 生成后，复制公钥到 ${DBEAVER_HOME}/plugins/com.dbeaver.app.ultimate_版本号.jar中的key文件夹的public-key位置
 * 然后打开dbeaver，输入生成的license.txt
 * <ul>
...
public class DBeaverLicenseCrack {
    ...
    private static final String DBEAVER_ECLIPSE_HOME = "C:\\software\\database\\DBeaver";
